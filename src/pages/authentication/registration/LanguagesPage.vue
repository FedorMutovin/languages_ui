<template>
  <div class="q-gutter-md q-pa-md flex justify-center">
    <div class="flex full-width justify-center text-h6 text-center">
      {{ $t("account.choose_language") }}
    </div>
    <q-card
      v-ripple:primary
      ...
      flat
      bordered
      v-for="language in languagesStore.for_learning"
      :key="language.id"
      class="flex column cursor-pointer q-hoverable"
      style="width: 150px"
    >
      <div class="flex flex-center q-mt-lg full-width">
        <country-flag
          rounded
          :country="languagesStore.getFlagCodeByLocale(language.locale)"
          size="big"
        />
      </div>
